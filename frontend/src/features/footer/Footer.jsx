    ...
    >
      ...
      >
        ...
        <Stack rowGap={"1rem"} padding={"1rem"}>
          ...
          <Typography sx={labelStyles}>
            11th Main Street, sector v, Salt lake, India.
          </Typography>
          <Typography sx={labelStyles}>grocergenie@gmail.com</Typography>
          <Typography sx={labelStyles}>+919999999999</Typography>
        </Stack>
      ...
      <Stack alignSelf={"center"}>
        <Typography color={"GrayText"}>
          &copy; GrocerGenie {new Date().getFullYear()}. All right reserved
        </Typography>
      </Stack>
    </Stack>
  );
